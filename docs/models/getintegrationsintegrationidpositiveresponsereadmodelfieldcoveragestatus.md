...
```python
from kombo.models import GetIntegrationsIntegrationIDPositiveResponseReadModelFieldCoverageStatus
value: GetIntegrationsIntegrationIDPositiveResponseReadModelFieldCoverageStatus = "SUPPORTED"
```
