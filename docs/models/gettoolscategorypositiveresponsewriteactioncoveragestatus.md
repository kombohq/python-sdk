...
```python
from kombo.models import GetToolsCategoryPositiveResponseWriteActionCoverageStatus
value: GetToolsCategoryPositiveResponseWriteActionCoverageStatus = "SUPPORTED"
```
