...
```python
from kombo.models import GetToolsCategoryPositiveResponseWriteActionFieldCoverageStatus
value: GetToolsCategoryPositiveResponseWriteActionFieldCoverageStatus = "SUPPORTED"
```
