...
```python
from kombo.models import GetIntegrationsIntegrationIDPositiveResponseWriteActionFieldCoverageStatus
value: GetIntegrationsIntegrationIDPositiveResponseWriteActionFieldCoverageStatus = "SUPPORTED"
```
