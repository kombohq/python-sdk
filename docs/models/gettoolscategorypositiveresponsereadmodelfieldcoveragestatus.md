...
```python
from kombo.models import GetToolsCategoryPositiveResponseReadModelFieldCoverageStatus
value: GetToolsCategoryPositiveResponseReadModelFieldCoverageStatus = "SUPPORTED"
```
