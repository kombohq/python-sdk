...
```python
from kombo.models import GetToolsCategoryPositiveResponseReadModelCoverageStatus
value: GetToolsCategoryPositiveResponseReadModelCoverageStatus = "SUPPORTED"
```
