...
[`SDKError`](https://github.com/kombohq/python-sdk/blob/master/./src/openapi/errors/sdkerror.py) is the base class for all HTTP error responses. It has the following properties:
...
### Error Classes
**Primary error:**
* [`SDKError`](https://github.com/kombohq/python-sdk/blob/master/./src/openapi/errors/sdkerror.py): The base class for HTTP error responses.
...
**Inherit from [`SDKError`](https://github.com/kombohq/python-sdk/blob/master/./src/openapi/errors/sdkerror.py)**:
* [`KomboAtsError`](https://github.com/kombohq/python-sdk/blob/master/./src/openapi/errors/komboatserror.py): The standard error response with the error codes for the ATS use case. Applicable to 27 of 57 methods.*
* [`KomboHrisError`](https://github.com/kombohq/python-sdk/blob/master/./src/openapi/errors/kombohriserror.py): The standard error response with the error codes for the HRIS use case. Applicable to 17 of 57 methods.*
* [`KomboGeneralError`](https://github.com/kombohq/python-sdk/blob/master/./src/openapi/errors/kombogeneralerror.py): The standard error response with just the platform error codes. Applicable to 13 of 57 methods.*
* [`ResponseValidationError`](https://github.com/kombohq/python-sdk/blob/master/./src/openapi/errors/responsevalidationerror.py): Type mismatch between the response data and the expected Pydantic model. Provides access to the Pydantic validation error via the `cause` attribute.
