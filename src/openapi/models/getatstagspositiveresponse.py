...
class GetAtsTagsPositiveResponseResultTypedDict(TypedDict):
    id: str
...
class GetAtsTagsPositiveResponseResult(BaseModel):
    id: str
    r"""The globally unique ID of this object generated by Kombo. We recommend using this as a stable primary key for syncing."""
...
class GetAtsTagsPositiveResponseDataTypedDict(TypedDict):
    next: Nullable[str]
    ...
    results: List[GetAtsTagsPositiveResponseResultTypedDict]


class GetAtsTagsPositiveResponseData(BaseModel):
    next: Nullable[str]
    r"""Cursor string that can be passed to the `cursor` query parameter to get the next page. If this is `null`, then there are no more pages."""

    results: List[GetAtsTagsPositiveResponseResult]
...
class GetAtsTagsPositiveResponseTypedDict(TypedDict):
    data: GetAtsTagsPositiveResponseDataTypedDict
    status: Literal["success"]


class GetAtsTagsPositiveResponse(BaseModel):
