...
GetHrisGroupsPositiveResponseType = Literal[
    "DEPARTMENT",
    "TEAM",
    "COST_CENTER",
]
...
class GetHrisGroupsPositiveResponseResultTypedDict(TypedDict):
    id: str
    ...
    https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toISOString
    """
    type: Nullable[GetHrisGroupsPositiveResponseType]
    r"""Type of the group."""
    parent_id: Nullable[str]
    r"""The Kombo ID of the group’s parent group in the organizational structure. The ID can be used to retrieve the group from the `get groups` endpoint."""


class GetHrisGroupsPositiveResponseResult(BaseModel):
    id: str
    r"""The globally unique ID of this object generated by Kombo. We recommend using this as a stable primary key for syncing."""
    ...
    def serialize_model(self, handler):
        optional_fields = []
        nullable_fields = ["name", "remote_deleted_at", "type", "parent_id"]
        null_default_fields = []
...
class GetHrisGroupsPositiveResponseDataTypedDict(TypedDict):
    next: Nullable[str]
    ...
    results: List[GetHrisGroupsPositiveResponseResultTypedDict]


class GetHrisGroupsPositiveResponseData(BaseModel):
    next: Nullable[str]
    r"""Cursor string that can be passed to the `cursor` query parameter to get the next page. If this is `null`, then there are no more pages."""

    results: List[GetHrisGroupsPositiveResponseResult]
...
class GetHrisGroupsPositiveResponseTypedDict(TypedDict):
    data: GetHrisGroupsPositiveResponseDataTypedDict
    status: Literal["success"]


class GetHrisGroupsPositiveResponse(BaseModel):
