...
class Ats(BaseSDK):
    def get_applications(
        ...
        *,
        ...
        job_remote_ids: Optional[Iterable[str]] = None,
        current_stage_ids: Optional[Iterable[str]] = None,
        ...
        request = models.GetAtsApplicationsRequest(
            ...
            outcomes=utils.unmarshal(outcomes, Optional[List[str]]),
            job_ids=utils.unmarshal(job_ids, Optional[List[str]]),
            job_remote_ids=utils.unmarshal(job_remote_ids, Optional[List[str]]),
            current_stage_ids=utils.unmarshal(current_stage_ids, Optional[List[str]]),
    ...
    def create_candidate(
        ...
        *,
        ...
        screening_question_answers: Optional[
            Union[
                Iterable[models.PostAtsCandidatesRequestBodyScreeningQuestionAnswer],
                Iterable[
    ...
    def get_jobs(
        ...
        *,
        ...
        ids: Optional[Iterable[str]] = None,
        remote_ids: Optional[Iterable[str]] = None,
        job_codes: Optional[Iterable[str]] = None,
        post_url: Optional[str] = None,
        statuses: Optional[Iterable[str]] = None,
        employment_types: Optional[Iterable[str]] = None,
        ...
        request = models.GetAtsJobsRequest(
            ...
            ids=utils.unmarshal(ids, Optional[List[str]]),
            remote_ids=utils.unmarshal(remote_ids, Optional[List[str]]),
            job_codes=utils.unmarshal(job_codes, Optional[List[str]]),
            post_url=post_url,
            statuses=utils.unmarshal(statuses, Optional[List[str]]),
            employment_types=utils.unmarshal(employment_types, Optional[List[str]]),
            visibilities=utils.unmarshal(visibilities, Optional[List[str]]),
            remote_created_after=remote_created_after,
    ...
    def create_application(
        ...
        *,
        ...
        attachments: Optional[
            Union[
                Iterable[models.PostAtsJobsJobIDApplicationsRequestBodyAttachment],
                Iterable[
                    models.PostAtsJobsJobIDApplicationsRequestBodyAttachmentTypedDict
                ],
            ]
        ] = None,
        source: Optional[
    ...
    def get_roles(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.GetAtsRolesResponse]:
        r"""Get roles
        ...
        :param ids: Filter by a comma-separated list of IDs such as `222k7eCGyUdgt2JWZDNnkDs3,B5DVmypWENfU6eMe6gYDyJG3`.
        :param remote_ids: Filter by a comma-separated list of remote IDs.
        :param scopes: Filter by a comma-separated list of `SYSTEM`, `JOB`
        ...
        request = models.GetAtsRolesRequest(
            cursor=cursor,
            page_size=page_size,
            updated_after=updated_after,
            include_deleted=include_deleted,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.GetAtsRolesGlobals(
                integration_id=self.sdk_configuration.globals.integration_id,
            ),
            security=self.sdk_configuration.security,
            allow_empty_value=None,
        ...
        def next_func() -> Optional[models.GetAtsRolesResponse]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetAtsRolesResponse(
                result=unmarshal_json_response(
                    models.GetAtsRolesPositiveResponse, http_res
                ),
                next=next_func,
            )
        if utils.match_response(http_res, "default", "application/json"):
    ...
    async def get_roles_async(
        ...
        *,
        ...
        def next_func() -> Awaitable[Optional[models.GetAtsRolesResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
    ...
    def get_notes(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.GetAtsNotesResponse]:
        r"""Get notes
        ...
        :param ids: Filter by a comma-separated list of IDs such as `222k7eCGyUdgt2JWZDNnkDs3,B5DVmypWENfU6eMe6gYDyJG3`.
        :param remote_ids: Filter by a comma-separated list of remote IDs.
        :param candidate_ids: Filter by a comma-separated list of candidate IDs. Prefer filtering by `candidate_ids` when you want to download the full context available for a candidate, across all their applications.
        :param application_ids: Filter by a comma-separated list of application IDs. Use filtering by `application_ids` only if you want the context available for specific applications. Results do not include notes that only link to the candidate, but not the application.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.GetAtsNotesRequest(
            cursor=cursor,
            page_size=page_size,
            updated_after=updated_after,
            include_deleted=include_deleted,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.GetAtsNotesGlobals(
                integration_id=self.sdk_configuration.globals.integration_id,
            ),
            security=self.sdk_configuration.security,
            allow_empty_value=None,
        ...
        def next_func() -> Optional[models.GetAtsNotesResponse]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetAtsNotesResponse(
                result=unmarshal_json_response(
                    models.GetAtsNotesPositiveResponse, http_res
                ),
                next=next_func,
            )
        if utils.match_response(http_res, "default", "application/json"):
    ...
    async def get_notes_async(
        ...
        *,
        ...
        def next_func() -> Awaitable[Optional[models.GetAtsNotesResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
    ...
    def get_ats_attachments(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.GetAtsAttachmentsResponse]:
        r"""Get attachments
        ...
        :param ids: Filter by a comma-separated list of IDs such as `222k7eCGyUdgt2JWZDNnkDs3,B5DVmypWENfU6eMe6gYDyJG3`.
        :param remote_ids: Filter by a comma-separated list of remote IDs.
        :param candidate_ids: Filter by a comma-separated list of candidate IDs. Prefer filtering by `candidate_ids` when you want every file a candidate has, across all their applications.
        :param application_ids: Filter by a comma-separated list of application IDs. We will only return attachments that the ATS filed under _any_ of these applications, which excludes the files that hang off the candidate directly.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.GetAtsAttachmentsRequest(
            cursor=cursor,
            page_size=page_size,
            updated_after=updated_after,
            include_deleted=include_deleted,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.GetAtsAttachmentsGlobals(
                integration_id=self.sdk_configuration.globals.integration_id,
            ),
            security=self.sdk_configuration.security,
            allow_empty_value=None,
        ...
        def next_func() -> Optional[models.GetAtsAttachmentsResponse]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
            ...
            return self.get_ats_attachments(
                cursor=next_cursor,
                page_size=page_size,
                updated_after=updated_after,
                include_deleted=include_deleted,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetAtsAttachmentsResponse(
                result=unmarshal_json_response(
                    models.GetAtsAttachmentsPositiveResponse, http_res
                ),
                next=next_func,
            )
        if utils.match_response(http_res, "default", "application/json"):
    ...
    async def get_ats_attachments_async(
        self,
        *,
        cursor: Optional[str] = None,
        page_size: Optional[int] = 100,
        ...
        def next_func() -> Awaitable[Optional[models.GetAtsAttachmentsResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
            ...
            return self.get_ats_attachments_async(
                cursor=next_cursor,
                page_size=page_size,
                updated_after=updated_after,
                include_deleted=include_deleted,
