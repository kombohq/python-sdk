...
class Hris(BaseSDK):
    def get_employees(
        ...
        *,
        ...
        employment_statuses: Optional[Iterable[str]] = None,
        group_ids: Optional[Iterable[str]] = None,
        legal_entity_ids: Optional[Iterable[str]] = None,
        work_location_ids: Optional[Iterable[str]] = None,
        work_emails: Optional[Iterable[str]] = None,
        personal_emails: Optional[Iterable[str]] = None,
        ...
        request = models.GetHrisEmployeesRequest(
            ...
            employment_statuses=utils.unmarshal(
                employment_statuses, Optional[List[str]]
            ),
            group_ids=utils.unmarshal(group_ids, Optional[List[str]]),
            legal_entity_ids=utils.unmarshal(legal_entity_ids, Optional[List[str]]),
            work_location_ids=utils.unmarshal(work_location_ids, Optional[List[str]]),
            work_emails=utils.unmarshal(work_emails, Optional[List[str]]),
            personal_emails=utils.unmarshal(personal_emails, Optional[List[str]]),
    ...
    def create_employee_with_form(
        ...
        *,
        properties: Union[
            Mapping[str, models.Schema4], Mapping[str, models.Schema4TypedDict]
        ],
        staffing_entity_id: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        request = models.PostHrisEmployeesFormRequestBody(
            staffing_entity_id=staffing_entity_id,
            properties=utils.unmarshal(properties, Dict[str, models.Schema4]),
        )
    ...
    def get_absences(
        ...
        *,
        ...
        type_ids: Optional[Iterable[str]] = None,
        employee_id: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.GetHrisAbsencesRequest(
            ...
            type_ids=utils.unmarshal(type_ids, Optional[List[str]]),
            employee_id=employee_id,
        )
    ...
    def get_performance_reviews(
        ...
        *,
        ...
        remote_ids: Optional[Iterable[str]] = None,
        types: Optional[Iterable[str]] = None,
        review_cycle_ids: Optional[Iterable[str]] = None,
        reviewee_ids: Optional[Iterable[str]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        request = models.GetHrisPerformanceReviewsRequest(
            ...
            remote_ids=utils.unmarshal(remote_ids, Optional[List[str]]),
            types=utils.unmarshal(types, Optional[List[str]]),
            review_cycle_ids=utils.unmarshal(review_cycle_ids, Optional[List[str]]),
            reviewee_ids=utils.unmarshal(reviewee_ids, Optional[List[str]]),
        )
    ...
    def get_staffing_entities(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.GetHrisStaffingEntitiesResponse]:
        r"""Get staffing entities
        ...
        :param ids: Filter by a comma-separated list of IDs such as `222k7eCGyUdgt2JWZDNnkDs3,B5DVmypWENfU6eMe6gYDyJG3`.
        :param remote_ids: Filter by a comma-separated list of remote IDs.
        :param model_types: Filter by a comma-separated list of `JOB`, `POSITION`, `REQUISITION`

            Leave this blank to get results matching all values.
        :param statuses: Filter by a comma-separated list of `OPEN_LIMITED`, `OPEN_UNLIMITED`, `PENDING`, `FROZEN`, `FILLED`, `CLOSED`
        ...
        request = models.GetHrisStaffingEntitiesRequest(
            cursor=cursor,
            page_size=page_size,
            updated_after=updated_after,
            include_deleted=include_deleted,
            ...
            ids=utils.unmarshal(ids, Optional[List[str]]),
            remote_ids=utils.unmarshal(remote_ids, Optional[List[str]]),
            model_types=utils.unmarshal(model_types, Optional[List[str]]),
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.GetHrisStaffingEntitiesGlobals(
                integration_id=self.sdk_configuration.globals.integration_id,
            ),
            security=self.sdk_configuration.security,
            allow_empty_value=None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetHrisStaffingEntitiesResponse(
                result=unmarshal_json_response(
                    models.GetHrisStaffingEntitiesPositiveResponse, http_res
                ),
                next=next_func,
            )
        if utils.match_response(http_res, "default", "application/json"):
    ...
    async def get_staffing_entities_async(
        self,
        *,
        cursor: Optional[str] = None,
        page_size: Optional[int] = 100,
        ...
        def next_func() -> Awaitable[Optional[models.GetHrisStaffingEntitiesResponse]]:
            ...
            return self.get_staffing_entities_async(
                cursor=next_cursor,
                page_size=page_size,
                updated_after=updated_after,
                include_deleted=include_deleted,
    ...
    def get_hris_pay_runs(
        ...
        *,
        ...
        :param ids: Filter by a comma-separated list of IDs such as `222k7eCGyUdgt2JWZDNnkDs3,B5DVmypWENfU6eMe6gYDyJG3`.
        :param remote_ids: Filter by a comma-separated list of remote IDs.
        :param legal_entity_ids: Filter by a comma-separated list of legal entity IDs.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.GetHrisPayRunsRequest(
            cursor=cursor,
            page_size=page_size,
            updated_after=updated_after,
            include_deleted=include_deleted,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.GetHrisPayRunsGlobals(
                integration_id=self.sdk_configuration.globals.integration_id,
            ),
            security=self.sdk_configuration.security,
            allow_empty_value=None,
        ...
        def next_func() -> Optional[models.GetHrisPayRunsResponse]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetHrisPayRunsResponse(
                result=unmarshal_json_response(
                    models.GetHrisPayRunsPositiveResponse, http_res
                ),
                next=next_func,
            )
        if utils.match_response(http_res, "default", "application/json"):
    ...
    async def get_hris_pay_runs_async(
        self,
        *,
        cursor: Optional[str] = None,
        page_size: Optional[int] = 100,
        ...
        def next_func() -> Awaitable[Optional[models.GetHrisPayRunsResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
            ...
            return self.get_hris_pay_runs_async(
                cursor=next_cursor,
                page_size=page_size,
                updated_after=updated_after,
                include_deleted=include_deleted,
    ...
    def get_hris_payslips(
        ...
        *,
        ...
        payrun_ids: Optional[Iterable[str]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.GetHrisPayslipsResponse]:
        r"""Payslips
        ...
        :param remote_ids: Filter by a comma-separated list of remote IDs.
        :param legal_entity_ids: Filter by a comma-separated list of legal entity IDs.
        :param employee_ids: Filter by a comma-separated list of employee IDs.
        :param payrun_ids: Filter by a comma-separated list of payrun IDs.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.GetHrisPayslipsRequest(
            cursor=cursor,
            page_size=page_size,
            updated_after=updated_after,
            include_deleted=include_deleted,
            ...
            remote_ids=utils.unmarshal(remote_ids, Optional[List[str]]),
            legal_entity_ids=utils.unmarshal(legal_entity_ids, Optional[List[str]]),
            employee_ids=utils.unmarshal(employee_ids, Optional[List[str]]),
            payrun_ids=utils.unmarshal(payrun_ids, Optional[List[str]]),
        )
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.GetHrisPayslipsGlobals(
                integration_id=self.sdk_configuration.globals.integration_id,
            ),
            security=self.sdk_configuration.security,
            allow_empty_value=None,
        ...
        def next_func() -> Optional[models.GetHrisPayslipsResponse]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetHrisPayslipsResponse(
                result=unmarshal_json_response(
                    models.GetHrisPayslipsPositiveResponse, http_res
                ),
                next=next_func,
            )
        if utils.match_response(http_res, "default", "application/json"):
    ...
    async def get_hris_payslips_async(
        self,
        *,
        cursor: Optional[str] = None,
        page_size: Optional[int] = 100,
        ...
        def next_func() -> Awaitable[Optional[models.GetHrisPayslipsResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
            ...
            return self.get_hris_payslips_async(
                cursor=next_cursor,
                page_size=page_size,
                updated_after=updated_after,
                include_deleted=include_deleted,
