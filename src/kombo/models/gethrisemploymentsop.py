...
class GetHrisEmploymentsGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetHrisEmploymentsGlobals(BaseModel):
...
class GetHrisEmploymentsRequestTypedDict(TypedDict):
...
class GetHrisEmploymentsRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetHrisEmploymentsResponseTypedDict(TypedDict):
    result: GetHrisEmploymentsPositiveResponseTypedDict


class GetHrisEmploymentsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetHrisEmploymentsResponse]],
        Callable[[], Awaitable[Optional[GetHrisEmploymentsResponse]]],
    ]

    result: GetHrisEmploymentsPositiveResponse
