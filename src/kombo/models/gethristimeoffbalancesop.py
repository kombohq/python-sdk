...
class GetHrisTimeOffBalancesGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetHrisTimeOffBalancesGlobals(BaseModel):
...
class GetHrisTimeOffBalancesRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetHrisTimeOffBalancesResponseTypedDict(TypedDict):
    result: GetHrisTimeOffBalancesPositiveResponseTypedDict


class GetHrisTimeOffBalancesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetHrisTimeOffBalancesResponse]],
        Callable[[], Awaitable[Optional[GetHrisTimeOffBalancesResponse]]],
    ]

    result: GetHrisTimeOffBalancesPositiveResponse
