...
class GetHrisPerformanceReviewsGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetHrisPerformanceReviewsGlobals(BaseModel):
...
class GetHrisPerformanceReviewsRequestTypedDict(TypedDict):
    ...
    r"""Filter by a comma-separated list of `MANAGER`, `DIRECT_REPORT`, `PEER`, `SELF`

    Leave this blank to get results matching all values.
    """
    review_cycle_ids: NotRequired[List[str]]
    r"""Filter by a comma-separated list of review cycle IDs."""
    reviewee_ids: NotRequired[List[str]]
    r"""Filter by a comma-separated list of reviewee IDs."""


class GetHrisPerformanceReviewsRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
    ...
    review_cycle_ids: Annotated[
        Optional[List[str]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=False)),
    ] = None
    r"""Filter by a comma-separated list of review cycle IDs."""

    reviewee_ids: Annotated[
        Optional[List[str]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=False)),
    ] = None
    r"""Filter by a comma-separated list of reviewee IDs."""
...
class GetHrisPerformanceReviewsResponseTypedDict(TypedDict):
    result: GetHrisPerformanceReviewsPositiveResponseTypedDict


class GetHrisPerformanceReviewsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetHrisPerformanceReviewsResponse]],
        Callable[[], Awaitable[Optional[GetHrisPerformanceReviewsResponse]]],
    ]

    result: GetHrisPerformanceReviewsPositiveResponse
