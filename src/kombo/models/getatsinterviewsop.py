...
class GetAtsInterviewsGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetAtsInterviewsGlobals(BaseModel):
...
class GetAtsInterviewsRequestTypedDict(TypedDict):
    ...
    r"""Filter by a comma-separated list of job IDs. We will only return interviews for applications associated with any of these jobs."""


class GetAtsInterviewsRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetAtsInterviewsResponseTypedDict(TypedDict):
    result: GetAtsInterviewsPositiveResponseTypedDict


class GetAtsInterviewsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetAtsInterviewsResponse]],
        Callable[[], Awaitable[Optional[GetAtsInterviewsResponse]]],
    ]

    result: GetAtsInterviewsPositiveResponse
