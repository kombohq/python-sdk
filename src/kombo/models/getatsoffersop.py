...
class GetAtsOffersGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetAtsOffersGlobals(BaseModel):
...
class GetAtsOffersRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetAtsOffersResponseTypedDict(TypedDict):
    result: GetAtsOffersPositiveResponseTypedDict


class GetAtsOffersResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetAtsOffersResponse]],
        Callable[[], Awaitable[Optional[GetAtsOffersResponse]]],
    ]

    result: GetAtsOffersPositiveResponse
