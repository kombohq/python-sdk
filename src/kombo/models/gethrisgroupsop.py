...
class GetHrisGroupsGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetHrisGroupsGlobals(BaseModel):
...
class GetHrisGroupsRequestTypedDict(TypedDict):
    ...
    r"""Filter by a comma-separated list of group types: `DEPARTMENT`, `TEAM`, `COST_CENTER`, or `null` to filter groups without a type.

    Leave this blank to get results matching all values.
    """
    name_contains: NotRequired[str]
    r"""Filter by the `name` field. Can be used to find a group by keywords present in the group name."""


class GetHrisGroupsRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetHrisGroupsResponseTypedDict(TypedDict):
    result: GetHrisGroupsPositiveResponseTypedDict


class GetHrisGroupsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetHrisGroupsResponse]],
        Callable[[], Awaitable[Optional[GetHrisGroupsResponse]]],
    ]

    result: GetHrisGroupsPositiveResponse
