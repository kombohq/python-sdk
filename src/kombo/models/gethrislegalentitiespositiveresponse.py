...
class GetHrisLegalEntitiesPositiveResponseAddressTypedDict(TypedDict):
...
class GetHrisLegalEntitiesPositiveResponseAddress(BaseModel):
    r"""The legal entity’s address."""
...
class GetHrisLegalEntitiesPositiveResponseResultTypedDict(TypedDict):
    id: str
    ...
    https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toISOString
    """
    address: NotRequired[Nullable[GetHrisLegalEntitiesPositiveResponseAddressTypedDict]]
    r"""The legal entity’s address."""


class GetHrisLegalEntitiesPositiveResponseResult(BaseModel):
    id: str
    r"""The globally unique ID of this object generated by Kombo. We recommend using this as a stable primary key for syncing."""
    ...
    address: OptionalNullable[GetHrisLegalEntitiesPositiveResponseAddress] = UNSET
    r"""The legal entity’s address."""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["address"])
        nullable_fields = set(["remote_id", "name", "address", "remote_deleted_at"])
        serialized = handler(self)
        m = {}
...
class GetHrisLegalEntitiesPositiveResponseDataTypedDict(TypedDict):
    next: Nullable[str]
    ...
    results: List[GetHrisLegalEntitiesPositiveResponseResultTypedDict]


class GetHrisLegalEntitiesPositiveResponseData(BaseModel):
    next: Nullable[str]
    r"""Cursor string that can be passed to the `cursor` query parameter to get the next page. If this is `null`, then there are no more pages."""

    results: List[GetHrisLegalEntitiesPositiveResponseResult]
...
class GetHrisLegalEntitiesPositiveResponseTypedDict(TypedDict):
    data: GetHrisLegalEntitiesPositiveResponseDataTypedDict
    status: Literal["success"]


class GetHrisLegalEntitiesPositiveResponse(BaseModel):
...
try:
    GetHrisLegalEntitiesPositiveResponse.model_rebuild()
except NameError:
    pass
