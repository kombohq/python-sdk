...
class GetAtsScorecardsGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetAtsScorecardsGlobals(BaseModel):
...
class GetAtsScorecardsRequestTypedDict(TypedDict):
    ...
    r"""Filter by a comma-separated list of candidate IDs. Prefer filtering by `candidate_ids` when you want to download the full interview feedback available for a candidate, across all their applications."""
    application_ids: NotRequired[List[str]]
    r"""Filter by a comma-separated list of application IDs. We will only return scorecards that belong to _any_ of these applications."""


class GetAtsScorecardsRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetAtsScorecardsResponseTypedDict(TypedDict):
    result: GetAtsScorecardsPositiveResponseTypedDict


class GetAtsScorecardsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetAtsScorecardsResponse]],
        Callable[[], Awaitable[Optional[GetAtsScorecardsResponse]]],
    ]

    result: GetAtsScorecardsPositiveResponse
