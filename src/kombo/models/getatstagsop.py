...
class GetAtsTagsGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetAtsTagsGlobals(BaseModel):
...
class GetAtsTagsRequestTypedDict(TypedDict):
...
class GetAtsTagsRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetAtsTagsResponseTypedDict(TypedDict):
    result: GetAtsTagsPositiveResponseTypedDict


class GetAtsTagsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetAtsTagsResponse]],
        Callable[[], Awaitable[Optional[GetAtsTagsResponse]]],
    ]

    result: GetAtsTagsPositiveResponse
