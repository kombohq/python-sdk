...
GetAtsApplicationStagesPositiveResponseStatus = Literal[
    "ACTIVE",
    "INACTIVE",
]
...
class GetAtsApplicationStagesPositiveResponseResultTypedDict(TypedDict):
    id: str
    ...
    status: Nullable[GetAtsApplicationStagesPositiveResponseStatus]
    r"""Whether the application stage is active in the ATS. Inactive stages (also e.g., archived or hidden) may still be referenced by existing applications but are typically not part of the current hiring workflow."""
...
class GetAtsApplicationStagesPositiveResponseResult(BaseModel):
    id: str
    r"""The globally unique ID of this object generated by Kombo. We recommend using this as a stable primary key for syncing."""
...
class GetAtsApplicationStagesPositiveResponseDataTypedDict(TypedDict):
    next: Nullable[str]
    ...
    results: List[GetAtsApplicationStagesPositiveResponseResultTypedDict]


class GetAtsApplicationStagesPositiveResponseData(BaseModel):
    next: Nullable[str]
    r"""Cursor string that can be passed to the `cursor` query parameter to get the next page. If this is `null`, then there are no more pages."""

    results: List[GetAtsApplicationStagesPositiveResponseResult]
...
class GetAtsApplicationStagesPositiveResponseTypedDict(TypedDict):
    data: GetAtsApplicationStagesPositiveResponseDataTypedDict
    status: Literal["success"]


class GetAtsApplicationStagesPositiveResponse(BaseModel):
...
try:
    GetAtsApplicationStagesPositiveResponse.model_rebuild()
except NameError:
    pass
