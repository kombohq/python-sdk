...
class GetAtsRejectionReasonsPositiveResponseResultTypedDict(TypedDict):
    id: str
    ...
    name: Nullable[str]
    r"""The title of the rejection reason."""
    changed_at: datetime
...
class GetAtsRejectionReasonsPositiveResponseResult(BaseModel):
    id: str
    r"""The globally unique ID of this object generated by Kombo. We recommend using this as a stable primary key for syncing."""
...
class GetAtsRejectionReasonsPositiveResponseDataTypedDict(TypedDict):
    next: Nullable[str]
    ...
    results: List[GetAtsRejectionReasonsPositiveResponseResultTypedDict]


class GetAtsRejectionReasonsPositiveResponseData(BaseModel):
    next: Nullable[str]
    r"""Cursor string that can be passed to the `cursor` query parameter to get the next page. If this is `null`, then there are no more pages."""

    results: List[GetAtsRejectionReasonsPositiveResponseResult]
...
class GetAtsRejectionReasonsPositiveResponseTypedDict(TypedDict):
    data: GetAtsRejectionReasonsPositiveResponseDataTypedDict
    status: Literal["success"]


class GetAtsRejectionReasonsPositiveResponse(BaseModel):
...
try:
    GetAtsRejectionReasonsPositiveResponse.model_rebuild()
except NameError:
    pass
