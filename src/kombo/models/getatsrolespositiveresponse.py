...
GetAtsRolesPositiveResponseScope = Literal[
    "SYSTEM",
    "JOB",
]
...
GetAtsRolesPositiveResponseUnifiedType = Literal[
    "HIRING_MANAGER",
    "RECRUITER",
    "COORDINATOR",
    "SOURCER",
...
class GetAtsRolesPositiveResponseResultTypedDict(TypedDict):
    id: str
    ...
    scope: Nullable[GetAtsRolesPositiveResponseScope]
    r"""Whether the role applies globally or is scoped to a specific job."""
    unified_type: Nullable[GetAtsRolesPositiveResponseUnifiedType]
    r"""Unified role type if Kombo can map it."""
    changed_at: datetime
...
class GetAtsRolesPositiveResponseResult(BaseModel):
    id: str
    r"""The globally unique ID of this object generated by Kombo. We recommend using this as a stable primary key for syncing."""
...
class GetAtsRolesPositiveResponseDataTypedDict(TypedDict):
    next: Nullable[str]
    ...
    results: List[GetAtsRolesPositiveResponseResultTypedDict]


class GetAtsRolesPositiveResponseData(BaseModel):
    next: Nullable[str]
    r"""Cursor string that can be passed to the `cursor` query parameter to get the next page. If this is `null`, then there are no more pages."""

    results: List[GetAtsRolesPositiveResponseResult]
...
class GetAtsRolesPositiveResponseTypedDict(TypedDict):
    data: GetAtsRolesPositiveResponseDataTypedDict
    status: Literal["success"]


class GetAtsRolesPositiveResponse(BaseModel):
...
try:
    GetAtsRolesPositiveResponse.model_rebuild()
except NameError:
    pass
