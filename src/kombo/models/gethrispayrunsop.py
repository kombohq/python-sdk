...
class GetHrisPayRunsGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetHrisPayRunsGlobals(BaseModel):
...
class GetHrisPayRunsRequestTypedDict(TypedDict):
...
class GetHrisPayRunsRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetHrisPayRunsResponseTypedDict(TypedDict):
    result: GetHrisPayRunsPositiveResponseTypedDict


class GetHrisPayRunsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetHrisPayRunsResponse]],
        Callable[[], Awaitable[Optional[GetHrisPayRunsResponse]]],
    ]

    result: GetHrisPayRunsPositiveResponse
