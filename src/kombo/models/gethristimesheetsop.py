...
class GetHrisTimesheetsGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetHrisTimesheetsGlobals(BaseModel):
...
class GetHrisTimesheetsRequestTypedDict(TypedDict):
    ...
    r"""Returns timesheets for a specific employee."""
    started_before: NotRequired[datetime]
    r"""Return timesheets whose start time is before the given timestamp."""
    started_after: NotRequired[datetime]
    r"""Return timesheets whose start time is on or after the given timestamp."""
    ended_before: NotRequired[datetime]
    r"""Return timesheets whose end time is on or before the given timestamp."""
    ended_after: NotRequired[datetime]
    r"""Return timesheets whose end time is on or after the given timestamp."""


class GetHrisTimesheetsRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetHrisTimesheetsResponseTypedDict(TypedDict):
    result: GetHrisTimesheetsPositiveResponseTypedDict


class GetHrisTimesheetsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetHrisTimesheetsResponse]],
        Callable[[], Awaitable[Optional[GetHrisTimesheetsResponse]]],
    ]

    result: GetHrisTimesheetsPositiveResponse
