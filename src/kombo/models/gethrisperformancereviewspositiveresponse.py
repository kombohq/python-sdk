...
class GetHrisPerformanceReviewsPositiveResponseResult(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["summary_rating"])
        nullable_fields = set(
            [
                "type",
                "summary_comment",
...
try:
    SummaryRatingSingleSelect.model_rebuild()
except NameError:
    pass
try:
    SummaryRatingNumeric.model_rebuild()
except NameError:
    pass
try:
    GetHrisPerformanceReviewsPositiveResponse.model_rebuild()
except NameError:
    pass
