...
class GetHrisEmployeeDocumentCategoriesPositiveResponseResultTypedDict(TypedDict):
    id: str
    ...
    name: Nullable[str]
    r"""The employee document category name. For example, \"Employment contract\"."""
    changed_at: datetime
...
class GetHrisEmployeeDocumentCategoriesPositiveResponseResult(BaseModel):
    id: str
    r"""The globally unique ID of this object generated by Kombo. We recommend using this as a stable primary key for syncing."""
...
class GetHrisEmployeeDocumentCategoriesPositiveResponseDataTypedDict(TypedDict):
    next: Nullable[str]
    ...
    results: List[GetHrisEmployeeDocumentCategoriesPositiveResponseResultTypedDict]


class GetHrisEmployeeDocumentCategoriesPositiveResponseData(BaseModel):
    next: Nullable[str]
    r"""Cursor string that can be passed to the `cursor` query parameter to get the next page. If this is `null`, then there are no more pages."""

    results: List[GetHrisEmployeeDocumentCategoriesPositiveResponseResult]
...
class GetHrisEmployeeDocumentCategoriesPositiveResponseTypedDict(TypedDict):
    data: GetHrisEmployeeDocumentCategoriesPositiveResponseDataTypedDict
    status: Literal["success"]


class GetHrisEmployeeDocumentCategoriesPositiveResponse(BaseModel):
...
try:
    GetHrisEmployeeDocumentCategoriesPositiveResponse.model_rebuild()
except NameError:
    pass
