...
class GetAtsUsersGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetAtsUsersGlobals(BaseModel):
...
class GetAtsUsersRequestTypedDict(TypedDict):
    ...
    r"""Filter by a comma-separated list of emails. We will only return users who have _any_ of the emails. The format of the emails is case-insensitive."""


class GetAtsUsersRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetAtsUsersResponseTypedDict(TypedDict):
    result: GetAtsUsersPositiveResponseTypedDict


class GetAtsUsersResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetAtsUsersResponse]],
        Callable[[], Awaitable[Optional[GetAtsUsersResponse]]],
    ]

    result: GetAtsUsersPositiveResponse
