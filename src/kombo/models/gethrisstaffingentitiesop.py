...
class GetHrisStaffingEntitiesGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetHrisStaffingEntitiesGlobals(BaseModel):
...
class GetHrisStaffingEntitiesRequestTypedDict(TypedDict):
    ...
    model_types: NotRequired[List[str]]
    r"""Filter by a comma-separated list of `JOB`, `POSITION`, `REQUISITION`

    Leave this blank to get results matching all values.
    """
    statuses: NotRequired[List[str]]
    r"""Filter by a comma-separated list of `OPEN_LIMITED`, `OPEN_UNLIMITED`, `PENDING`, `FROZEN`, `FILLED`, `CLOSED`

    Leave this blank to get results matching all values.
    """


class GetHrisStaffingEntitiesRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetHrisStaffingEntitiesResponseTypedDict(TypedDict):
    result: GetHrisStaffingEntitiesPositiveResponseTypedDict


class GetHrisStaffingEntitiesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetHrisStaffingEntitiesResponse]],
        Callable[[], Awaitable[Optional[GetHrisStaffingEntitiesResponse]]],
    ]

    result: GetHrisStaffingEntitiesPositiveResponse
