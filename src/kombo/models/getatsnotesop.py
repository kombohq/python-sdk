...
class GetAtsNotesGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetAtsNotesGlobals(BaseModel):
...
class GetAtsNotesRequestTypedDict(TypedDict):
    ...
    r"""Filter by a comma-separated list of candidate IDs. Prefer filtering by `candidate_ids` when you want to download the full context available for a candidate, across all their applications."""
    application_ids: NotRequired[List[str]]
    r"""Filter by a comma-separated list of application IDs. Use filtering by `application_ids` only if you want the context available for specific applications. Results do not include notes that only link to the candidate, but not the application."""


class GetAtsNotesRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetAtsNotesResponseTypedDict(TypedDict):
    result: GetAtsNotesPositiveResponseTypedDict


class GetAtsNotesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetAtsNotesResponse]],
        Callable[[], Awaitable[Optional[GetAtsNotesResponse]]],
    ]

    result: GetAtsNotesPositiveResponse
