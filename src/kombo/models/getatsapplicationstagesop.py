...
class GetAtsApplicationStagesGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetAtsApplicationStagesGlobals(BaseModel):
...
class GetAtsApplicationStagesRequestTypedDict(TypedDict):
...
class GetAtsApplicationStagesRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetAtsApplicationStagesResponseTypedDict(TypedDict):
    result: GetAtsApplicationStagesPositiveResponseTypedDict


class GetAtsApplicationStagesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetAtsApplicationStagesResponse]],
        Callable[[], Awaitable[Optional[GetAtsApplicationStagesResponse]]],
    ]

    result: GetAtsApplicationStagesPositiveResponse
