...
class GetHrisPayslipsGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetHrisPayslipsGlobals(BaseModel):
...
class GetHrisPayslipsRequestTypedDict(TypedDict):
    ...
    r"""Filter by a comma-separated list of legal entity IDs."""
    employee_ids: NotRequired[List[str]]
    r"""Filter by a comma-separated list of employee IDs."""
    payrun_ids: NotRequired[List[str]]
    r"""Filter by a comma-separated list of payrun IDs."""


class GetHrisPayslipsRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetHrisPayslipsResponseTypedDict(TypedDict):
    result: GetHrisPayslipsPositiveResponseTypedDict


class GetHrisPayslipsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetHrisPayslipsResponse]],
        Callable[[], Awaitable[Optional[GetHrisPayslipsResponse]]],
    ]

    result: GetHrisPayslipsPositiveResponse
