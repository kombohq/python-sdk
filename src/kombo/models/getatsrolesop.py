...
class GetAtsRolesGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetAtsRolesGlobals(BaseModel):
...
class GetAtsRolesRequestTypedDict(TypedDict):
    ...
    r"""Filter by a comma-separated list of `SYSTEM`, `JOB`
...
class GetAtsRolesRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetAtsRolesResponseTypedDict(TypedDict):
    result: GetAtsRolesPositiveResponseTypedDict


class GetAtsRolesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetAtsRolesResponse]],
        Callable[[], Awaitable[Optional[GetAtsRolesResponse]]],
    ]

    result: GetAtsRolesPositiveResponse
