...
class GetHrisLocationsGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetHrisLocationsGlobals(BaseModel):
...
class GetHrisLocationsRequestTypedDict(TypedDict):
    ...
    r"""Filter by the `name` field. Can be used to find a location by keywords present in the location name."""


class GetHrisLocationsRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetHrisLocationsResponseTypedDict(TypedDict):
    result: GetHrisLocationsPositiveResponseTypedDict


class GetHrisLocationsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetHrisLocationsResponse]],
        Callable[[], Awaitable[Optional[GetHrisLocationsResponse]]],
    ]

    result: GetHrisLocationsPositiveResponse
