...
class GetHrisPerformanceReviewCyclesGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetHrisPerformanceReviewCyclesGlobals(BaseModel):
...
class GetHrisPerformanceReviewCyclesRequestTypedDict(TypedDict):
...
class GetHrisPerformanceReviewCyclesRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetHrisPerformanceReviewCyclesResponseTypedDict(TypedDict):
    result: GetHrisPerformanceReviewCyclesPositiveResponseTypedDict


class GetHrisPerformanceReviewCyclesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetHrisPerformanceReviewCyclesResponse]],
        Callable[[], Awaitable[Optional[GetHrisPerformanceReviewCyclesResponse]]],
    ]

    result: GetHrisPerformanceReviewCyclesPositiveResponse
