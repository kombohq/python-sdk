...
class GetHrisAbsenceTypesGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetHrisAbsenceTypesGlobals(BaseModel):
...
class GetHrisAbsenceTypesRequestTypedDict(TypedDict):
...
class GetHrisAbsenceTypesRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetHrisAbsenceTypesResponseTypedDict(TypedDict):
    result: GetHrisAbsenceTypesPositiveResponseTypedDict


class GetHrisAbsenceTypesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetHrisAbsenceTypesResponse]],
        Callable[[], Awaitable[Optional[GetHrisAbsenceTypesResponse]]],
    ]

    result: GetHrisAbsenceTypesPositiveResponse
