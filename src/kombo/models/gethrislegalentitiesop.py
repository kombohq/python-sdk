...
class GetHrisLegalEntitiesGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetHrisLegalEntitiesGlobals(BaseModel):
...
class GetHrisLegalEntitiesRequestTypedDict(TypedDict):
    ...
    r"""Filter by the `name` field. Can be used to find a legal entity by keywords present in the legal entity name."""


class GetHrisLegalEntitiesRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetHrisLegalEntitiesResponseTypedDict(TypedDict):
    result: GetHrisLegalEntitiesPositiveResponseTypedDict


class GetHrisLegalEntitiesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetHrisLegalEntitiesResponse]],
        Callable[[], Awaitable[Optional[GetHrisLegalEntitiesResponse]]],
    ]

    result: GetHrisLegalEntitiesPositiveResponse
