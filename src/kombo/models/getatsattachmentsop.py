...
class GetAtsAttachmentsGlobalsTypedDict(TypedDict):
    integration_id: NotRequired[str]
    r"""ID of the integration you want to interact with."""


class GetAtsAttachmentsGlobals(BaseModel):
...
class GetAtsAttachmentsRequestTypedDict(TypedDict):
    ...
    r"""Filter by a comma-separated list of candidate IDs. Prefer filtering by `candidate_ids` when you want every file a candidate has, across all their applications."""
    application_ids: NotRequired[List[str]]
    r"""Filter by a comma-separated list of application IDs. We will only return attachments that the ATS filed under _any_ of these applications, which excludes the files that hang off the candidate directly."""


class GetAtsAttachmentsRequest(BaseModel):
    cursor: Annotated[
        Optional[str],
...
class GetAtsAttachmentsResponseTypedDict(TypedDict):
    result: GetAtsAttachmentsPositiveResponseTypedDict


class GetAtsAttachmentsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetAtsAttachmentsResponse]],
        Callable[[], Awaitable[Optional[GetAtsAttachmentsResponse]]],
    ]

    result: GetAtsAttachmentsPositiveResponse
