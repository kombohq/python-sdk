...
try:
    GetIntegrationsIntegrationIDIntegrationFieldsPositiveResponseResult.model_rebuild()
except NameError:
    pass
try:
    GetIntegrationsIntegrationIDIntegrationFieldsPositiveResponse.model_rebuild()
except NameError:
    pass
