...
class GetAtsApplicationsPositiveResponseSocialMedia(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["link", "type", "username"])
        nullable_fields = set(["link", "type", "username"])
        serialized = handler(self)
        m = {}
...
class GetAtsApplicationsPositiveResponseCandidate(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["email_addresses", "phone_numbers", "social_media"])
        nullable_fields = set(
            [
                "first_name",
                "last_name",
...
CurrentStageStatus = Literal[
    "ACTIVE",
    "INACTIVE",
]
r"""Whether the application stage is active in the ATS. Inactive stages (also e.g., archived or hidden) may still be referenced by existing applications but are typically not part of the current hiring workflow."""
...
class GetAtsApplicationsPositiveResponseCurrentStageTypedDict(TypedDict):
    ...
    status: Nullable[CurrentStageStatus]
    r"""Whether the application stage is active in the ATS. Inactive stages (also e.g., archived or hidden) may still be referenced by existing applications but are typically not part of the current hiring workflow."""
...
class Interview(BaseModel):
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(
            ["remote_id", "title", "starting_at", "ending_at", "location", "canceled"]
        )
        serialized = handler(self)
        m = {}
...
class GetAtsApplicationsPositiveResponseResult(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["screening_question_answers"])
        nullable_fields = set(
            [
                "remote_id",
                "outcome",
...
try:
    GetAtsApplicationsPositiveResponseQuestionUnknown.model_rebuild()
except NameError:
    pass
try:
    GetAtsApplicationsPositiveResponseAnswer6.model_rebuild()
except NameError:
    pass
try:
    GetAtsApplicationsPositiveResponseQuestionDate.model_rebuild()
except NameError:
    pass
try:
    GetAtsApplicationsPositiveResponseQuestionNumber.model_rebuild()
except NameError:
    pass
try:
    GetAtsApplicationsPositiveResponseQuestionBoolean.model_rebuild()
except NameError:
    pass
try:
    GetAtsApplicationsPositiveResponseQuestionMultiSelect.model_rebuild()
except NameError:
    pass
try:
    GetAtsApplicationsPositiveResponseQuestionSingleSelect.model_rebuild()
except NameError:
    pass
try:
    GetAtsApplicationsPositiveResponseQuestionText.model_rebuild()
except NameError:
    pass
try:
    GetAtsApplicationsPositiveResponse.model_rebuild()
except NameError:
    pass
