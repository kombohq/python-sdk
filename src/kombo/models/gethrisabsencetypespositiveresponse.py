...
GetHrisAbsenceTypesPositiveResponseUnit = Literal[
    "HOURS",
    "DAYS",
]
...
class GetHrisAbsenceTypesPositiveResponseResultTypedDict(TypedDict):
    id: str
    ...
    unit: Nullable[GetHrisAbsenceTypesPositiveResponseUnit]
    r"""The time-unit of the absence."""
...
class GetHrisAbsenceTypesPositiveResponseResult(BaseModel):
    id: str
    r"""The globally unique ID of this object generated by Kombo. We recommend using this as a stable primary key for syncing."""
...
class GetHrisAbsenceTypesPositiveResponseDataTypedDict(TypedDict):
    next: Nullable[str]
    ...
    results: List[GetHrisAbsenceTypesPositiveResponseResultTypedDict]


class GetHrisAbsenceTypesPositiveResponseData(BaseModel):
    next: Nullable[str]
    r"""Cursor string that can be passed to the `cursor` query parameter to get the next page. If this is `null`, then there are no more pages."""

    results: List[GetHrisAbsenceTypesPositiveResponseResult]
...
class GetHrisAbsenceTypesPositiveResponseTypedDict(TypedDict):
    data: GetHrisAbsenceTypesPositiveResponseDataTypedDict
    status: Literal["success"]


class GetHrisAbsenceTypesPositiveResponse(BaseModel):
...
try:
    GetHrisAbsenceTypesPositiveResponse.model_rebuild()
except NameError:
    pass
